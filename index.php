              ...
              <div class="row as-search-navbar" id="as-search-navbar" style="width: auto;">
                <div class="as-accessories-filter-tile column large-6 small-3">
                  <button class="as-filter-button" aria-expanded="true" aria-controls="as-search-filters" type="button">
                    <h2 class=" as-filter-button-text">Smartphones</h2>
                  </button>
                </div>
              </div>
            </div>
              ...
              <div class="column small-12 as-search-results-tiles as-search-results-width">
                ...
                <div class="as-producttile large-4 small-6 group-1">
                    ...
                    <div class="images mini-gallery gal1 ">
                      <ul class="clearfix as-producttile-nojs">
                        <li class="as-searchtile-nojs">
                          <img src="./assets/samsung-galaxy-s9-xxl.jpg" class="ir relatedlink item-image as-producttile-image" alt="" width="445" height="445">
                        </li>
                      </ul>
                  ...
                  <div class="as-producttile-info" style="min-height: 168px;">
                    ...
                    <form action="<?php echo $config['base_url']; ?>detail.php" method="post">
                      <input type="hidden" name="token" value="<?php echo md5(time()); ?>">
                      <input type="hidden" name="img" value="<?php echo $config['base_url']; ?>assets/samsung-galaxy-s9-xxl.jpg">
                ...
                <div class="as-producttile large-4 small-6 group-1">
                  ...
                  <div class="as-producttile-info" style="min-height: 168px;">
                    ...
                    <form action="<?php echo $config['base_url']; ?>detail.php" method="post">
                      <input type="hidden" name="token" value="<?php echo md5(time()); ?>">
                      <input type="hidden" name="img" value="<?php echo $config['base_url']; ?>assets/l6g6.jpg">
                ...
                <div class="as-producttile large-4 small-6 group-1">
                  ...
                  <div class="as-producttile-info" style="min-height: 168px;">
                    ...
                    <form action="<?php echo $config['base_url']; ?>detail.php" method="post">
                      <input type="hidden" name="token" value="<?php echo md5(time()); ?>">
                      <input type="hidden" name="img" value="<?php echo $config['base_url']; ?>assets/u_10168742.jpg">
                ...
                <div class="as-producttile large-4 small-6 group-2">
                  ...
                  <div class="as-producttile-info" style="min-height: 168px;">
                    ...
                    <form action="<?php echo $config['base_url']; ?>detail.php" method="post">
                      <input type="hidden" name="token" value="<?php echo md5(time()); ?>">
                      <input type="hidden" name="img" value="<?php echo $config['base_url']; ?>assets/motorola-moto-g5-plus-1.jpg">
                ...
                <div class="as-producttile large-4 small-6 group-2">
                    ...
                    <div class="images mini-gallery gal4 ">
                      ...
                      <div class="as-isdesktop with-paddlenav with-paddlenav-onhover">
                        <div class="clearfix image-list xs-no-js as-util-relatedlink relatedlink" data-relatedlink="5|Beats Solo3 Wireless On-Ear Headphones - Neighborhood Collection - Break Blue|MQ392">
                          <div class="as-tilegallery-element as-image-selected">
                            <div class=""></div>
                            <img src="./assets/motorola-moto-g4-3.jpg" class="ir ir item-image as-producttile-image">
                          </div>
                  ...
                  <div class="as-producttile-info" style="min-height: 168px;">
                    ...
                    <form action="<?php echo $config['base_url']; ?>detail.php" method="post">
                      <input type="hidden" name="token" value="<?php echo md5(time()); ?>">
                      <input type="hidden" name="img" value="<?php echo $config['base_url']; ?>assets/motorola-moto-g4-3.jpg">
                ...
                <div class="as-producttile large-4 small-6 group-2">
                    ...
                    <div class="images mini-gallery gal5 ">
                      ...
                      <div class="as-isdesktop with-paddlenav with-paddlenav-onhover">
                        <div class="clearfix image-list xs-no-js as-util-relatedlink relatedlink" data-relatedlink="6|Powerbeats3 Wireless Earphones - Neighborhood Collection - Brick Red|MPXP2">
                          <div class="as-tilegallery-element as-image-selected">
                            <div class=""></div>
                            <img src="./assets/003.jpg" class="ir ir item-image as-producttile-image" alt="" width="445" height="445">
                          </div>
                  ...
                  <div class="as-producttile-info" style="min-height: 168px;">
                    ...
                    <form action="<?php echo $config['base_url']; ?>detail.php" method="post">
                      <input type="hidden" name="token" value="<?php echo md5(time()); ?>">
                      <input type="hidden" name="img" value="<?php echo $config['base_url']; ?>assets/003.jpg">
